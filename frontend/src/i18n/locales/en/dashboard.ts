export default {
  ...
  keys: {
    ...
    useKeyModal: {
      ...
      copy: 'Copy',
      copied: 'Copied',
      setupModeRecommended: 'Recommended setup',
      setupModeAdvanced: 'Advanced setup',
      quickSetup: {
        description: 'Select a client and model to generate a ready-to-use configuration. Endpoint suffixes such as /v1 are handled automatically.',
        client: 'Client',
        model: 'Available model',
        modelPlaceholder: 'Enter or select a model ID',
        modelLoading: 'Loading models available to this API key...',
        modelLoaded: 'Loaded {count} models for this API key. You can still enter a model ID manually.',
        modelLoadFailed: 'Could not load the model list. You can still enter a model ID manually.',
        refreshModels: 'Reload models',
        protocol: 'API protocol',
        responses: 'OpenAI Responses API',
        chat: 'OpenAI Chat Completions',
        protocolFixed: 'The native protocol for this group is selected automatically.',
        operatingSystem: 'Operating system',
        unix: 'macOS / Linux',
        windows: 'Windows',
        claudeMode: 'Claude model mapping',
        claudeSingle: 'Use one model',
        claudeFamily: 'Map Opus / Sonnet / Haiku separately',
        claudeSingleHint: 'All three Claude model families will use the selected model.',
        claudeFamilyHint: 'Empty mappings are omitted so client model names and server-side group mappings can resolve them.',
        opus: 'Opus model',
        sonnet: 'Sonnet model',
        haiku: 'Haiku model',
        optionalModel: 'Optional',
        mergeJson: 'This is a complete JSON example. Merge these fields into an existing file instead of overwriting unrelated settings.',
        mergeToml: 'This is a TOML configuration block. Merge it into an existing file and avoid duplicate section names.',
        codexEnv: 'The key is provided through an environment variable. Run this before starting Codex.',
